...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('fantasy_team', 'owner_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['fantasy.Member'], unique=True))
        # Adding unique constraint on 'Team', fields ['owner']
        db.create_unique('fantasy_team', ['owner_id'])

        # Deleting field 'Player.lv_team_id'
        db.delete_column('fantasy_player', 'lv_team_id')


    def backwards(self, orm):
        # Removing unique constraint on 'Team', fields ['owner']
        db.delete_unique('fantasy_team', ['owner_id'])


        # Changing field 'Team.owner'
        db.alter_column('fantasy_team', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fantasy.Member']))
        # Adding field 'Player.lv_team_id'
        db.add_column('fantasy_player', 'lv_team_id',
    ...
    models = {
        ...
        'fantasy.player': {
            ...
            'team': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'players'", 'to': "orm['fantasy.Team']"})
        },
        'fantasy.team': {
            ...
            'extra': ('lvfu.utils.fields.JSONField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['fantasy.Member']", 'unique': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '256'})
        }
    }
