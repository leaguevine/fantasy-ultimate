...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('fantasy_member', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)

        # Adding field 'Member.last_name'
        db.add_column('fantasy_member', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)

        # Adding field 'League.creator'
        db.add_column('fantasy_league', 'creator',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('fantasy_member', 'first_name')

        # Deleting field 'Member.last_name'
        db.delete_column('fantasy_member', 'last_name')

        # Deleting field 'League.creator'
        db.delete_column('fantasy_league', 'creator_id')
